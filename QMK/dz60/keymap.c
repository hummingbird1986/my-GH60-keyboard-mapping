...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	TT(2),KC_LALT,KC_LGUI, KC_SPC, KC_SPC, KC_SPC, KC_SPC,KC_RGUI,KC_RALT,KC_CAPS,KC_DEL),
    ...
    SFT_T(KC_MUTE),_______,KC_VOLD,KC_VOLU,_______,_______,_______,   KC_1,   KC_2,   KC_3,_______,  KC_UP,_______,_______,
    _______,_______,_______,   KC_0,   KC_0,   KC_0,   KC_0, KC_DOT,KC_LEFT,KC_DOWN,KC_RIGHT),
    
    [_HHKB]=LAYOUT(
    _______,  KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9, KC_F10, KC_F11, KC_F12,_______,_______,
    _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,  KC_UP,_______,KC_EJCT, 
    _______,_______,_______,_______,_______,_______,_______,_______,KC_HOME,  KC_UP,KC_LEFT,KC_RIGHT,_______, 
    _______,_______,_______,_______,_______,_______,_______,_______, KC_END,KC_DOWN,KC_DOWN,_______,_______,_______,
    _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______),
